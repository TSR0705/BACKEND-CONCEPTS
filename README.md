...
- [Projects](#-projects)  
  - [Authentication & Authorization – 01 🔐](#authentication--authorization--01-🔐)  
  - [Authentication & Authorization – 02 🔐 (In Progress)](#authentication--authorization--02-🔐-in-progress)  
  - [Backend Class Rough Work 📚](#backend-class-rough-work-📚)  
  - [Backend Practice Project – 01 🛠](#backend-practice-project–01-🛠)  
  - [MongoDB C‑R‑U‑D 01 🍃](#mongodb-c-r-u-d-01-🍃)  
  - [MongoDB C‑R‑U‑D 02 🌐](#mongodb-c-r-u-d-02-🌐)  
 * * *
## ⚙️ Prerequisites
...
## 1\. `AUTHENTICATION AND AUTHORIZATION – 01`
...
# 🔐 Authentication & Authorization – 02 *(In Progress)*
...
> _Add UI screenshots here (e.g., `screenshots/practice01-form.png` and `screenshots/practice01-card.png`) to showcase the form and task listing._
